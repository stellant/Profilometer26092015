...
namespace Profilometer_Keyence_WCF
{
    ...
    {
        //Ethernet Configuration Variable where we can give assign ipaddress and port
        private LJV7IF_ETHERNET_CONFIG _ethernetConfig;
        //List variable to hold measurement values
        private List<MeasureData> _measureDatas;
        //Current device id
        private int _currentDeviceId;
        //Profile Information Structure Array to hold information about profiles
        private LJV7IF_PROFILE_INFO[] _profileInfo;
        //Result variable to be returned to the client in the form of XML
        ...
        /// <summary>
        /// Method to fetch measurement values and profiles 
        /// </summary>
        /// <param name="ipAddress">IP Address of the Sensor</param>
        /// <param name="port">Port</param>
        /// <param name="type">Type of Data Whether Measurement Value or Profile with Measurement Value</param>
        /// <returns></returns>
        public XmlElement GetMeasurementValue(string ipAddress, string port, string type)
        {
            try
            {
                if (type.Trim().Equals("measurement"))
                {
                    ...
                    //fetches measurement values from the sensor and parsed into XML
                    _result = GetMeasurementValues();
                    //finalizes communication with the sensor
                ...
                else if (type.Trim().Equals("profile"))
                {
                    //initializes the communication with the sensor
                    InitializeCommunication(ipAddress, port, type);
                    //fetches profile with measurement value and returns the result in the form of XML
                    _result = GetProfileAdvanceValues();
                    //finalizes the communication with the sensor
                    FinalizeCommunication(ipAddress, port, type);
                }
        ...
        /// <summary>
        /// Method to construct measurement values from the sensor into XML format
        /// </summary>
        /// <param name="s">MeasureData Object</param>
        /// <returns>MeasureData in XML Format</returns>
        ...
        /// <summary>
        /// Method to construct profile with measurement value from the sensor in the form of XML
        /// </summary>
        /// <param name="s">Measure Data Object</param>
        /// <param name="p">Profile Data List Object</param>
        /// <returns>Profile with Measurement Value in XML Format</returns>
        private XmlElement GetProfileAdvanceValueXML(MeasureData s, List<ProfileData> p)
        {
            ...
            foreach (ProfileData profile in p)
            {
                ...
                {
                    XmlNode dataValue = document.CreateElement("Profile"+x);
                    dataValue.InnerText = string.Format("{0}",profile.ProfDatas[i] );
                    profileData.AppendChild(dataValue);
        ...
        /// <summary>
        /// Method generates Exception in the form of XML
        /// </summary>
        /// <param name="ex">Exception String</param>
        /// <returns>Exception String in XML Format</returns>
        ...
        /// <summary>
        /// Method initializes communication with the sensor
        /// </summary>
        /// <param name="ipAddress">IP Address</param>
        /// <param name="port">Port</param>
        /// <param name="type">Measument Value or Profile with Measurement Value</param>
        ...
        /// <summary>
        /// Method finalizes the communication with the sensor
        /// </summary>
        /// <param name="ipAddress">IP Address</param>
        /// <param name="port">Port</param>
        /// <param name="type">Measurement Value or Profile with Measurement Value</param>
        ...
        /// <summary>
        /// Method fetches measurement values from the sensor and returns in XML Format
        /// </summary>
        /// <returns>Measurement Value in XML Format</returns>
        ...
        /// <summary>
        /// Method fetches Profile with Measurement Value from the sensor and returns in XML Format
        /// </summary>
        /// <returns>Profile with Measurement Value in XML Format</returns>
       ...
       /* private XmlElement GetBatchProfileAdvanceValues()
        ...
        /// <summary>
        /// Method to generate timezone offset like Tz-offset
        /// </summary>
        /// <param name="timeZone">Time Zone</param>
        /// <returns>Time Zone Parsed</returns>
